...
function M.executable(adapter, engine_name, tool_name)
	local raw_cmd = server_field(adapter, engine_name, tool_name, engine_name .. "_cmd") or M.cmd(adapter, engine_name)
...
function M.info(adapter, engine_name, tool_name)
	...
	local info = {
		cmd = server_field(adapter, engine_name, tool_name, engine_name .. "_cmd"),
