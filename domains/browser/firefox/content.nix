...
let
  ...
  aboutVars = [
    ...
    {
      name = "newtab-background-color";
      value = theme.bg;
    }
    {
      name = "newtab-background-color-secondary";
      value = theme.bgVariant;
    }
    {
      name = "newtab-background-card";
      value = "color-mix(in srgb, ${theme.bgVariant} 85%, transparent)";
    }
    {
      name = "newtab-text-primary-color";
      value = theme.fg;
    }
    {
      name = "newtab-text-secondary-color";
      value = theme.fgVariant;
    }
    {
      name = "content-search-handoff-ui-background-color";
      value = theme.bgVariant;
    }
    {
      name = "content-search-handoff-ui-color";
      value = theme.fg;
    }
  ];
  ...
  newtabVars = [
    ...
    {
      name = "newtab-element-hover-color";
      value = theme.hoverBgHex;
    }
    {
      name = "newtab-element-active-color";
      value = theme.activeBgHex;
    }
    {
      name = "newtab-element-secondary-color";
      value = theme.hoverBgHex;
    }
    {
      name = "newtab-element-secondary-hover-color";
      value = theme.activeBgHex;
    }
    {
      name = "newtab-element-secondary-active-color";
      value = theme.activeBgHex;
    }
    {
      name = "content-search-handoff-ui-background-color";
    ...
    {
      name = "content-search-handoff-ui-fill";
      value = theme.fgVariant;
    }
    {
      name = "content-search-handoff-ui-caret-color";
      value = theme.fg;
    }
    {
      name = "content-search-handoff-ui-engine-icon";
      value = theme.fg;
    }
    {
      name = "newtab-primary-action-background";
      value = theme.accent;
    }
    {
      name = "newtab-primary-action-background-dimmed";
      value = "color-mix(in srgb, ${theme.accent} 25%, transparent)";
    }
    {
      name = "newtab-primary-element-text-color";
      value = theme.bg;
    }
    {
      name = "newtab-wordmark-color";
      value = theme.fg;
    }
    {
      name = "newtab-overlay-color";
      value = "color-mix(in srgb, ${theme.bg} 85%, transparent)";
    }
    {
      name = "newtab-button-background";
      value = theme.bgVariant;
    }
    {
      name = "newtab-button-hover-background";
      value = theme.hoverBgHex;
    }
    {
      name = "newtab-button-active-background";
      value = theme.activeBgHex;
    }
    {
      name = "newtab-button-text";
      value = theme.fg;
    }
    {
      name = "newtab-border-color";
      value = "transparent";
    }
  ];
  ...
  tstVars = [
    ...
    {
      name = "in-content-box-background-hover";
      value = theme.hoverBgHex;
    }
    {
      name = "in-content-box-background-active";
      value = theme.activeBgHex;
    }
    {
      name = "in-content-text-color";
