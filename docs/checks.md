...
`lint-themes` validates layered theme definitions and domain-local renderers. Rendered configs are validated by integration checks (`lint-desktop`, `lint-shell`, etc.).
