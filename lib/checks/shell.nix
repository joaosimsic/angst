...
let
  ...
  renderForTheme = themeName: {
    inherit themeName;
    starship = renderDomainOutputFor themeName "domains/shell/starship/config/starship.toml";
    nushellColors = renderDomainOutputFor themeName "domains/shell/nushell/config/colors.nu";
  };
